...
describe('Admin dashboard', () => {
  ...
  it('loads statistics and today appointments', () => {
    ...
    const notification = { id: 1, appointmentId: 2, recipientId: 1, type: 'STATUS_CHANGED', title: 'Statut modifié', message: 'Rendez-vous confirmé', createdAt: '2026-09-23T10:00:00', readAt: null };
